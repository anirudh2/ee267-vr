...
Now, you should have this repository in your local machine. Before pulling the following homework, you need to make a commit of your change in your local repository. (It is also okay to freshly clone this repository to your machine.)
