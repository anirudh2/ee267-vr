...
var StandardRenderer = function ( webglRenderer, teapots, dispParams ) {
	...
	var grid = new THREE.GridHelper( 2000, 20, "white", "white" );
	...
	var sqGrid = new THREE.GridHelper( 10000, 100, "gray", "gray" );
	...
	// Repalce NUM_POINT_LIGHTS and NUM_DIR_LIGHTS in the shaders to the number
	...
	// Peform rendering after updating uniforms
	//
	// INPUT
	// state: state object of StateController
	// modelMat: model matrix
